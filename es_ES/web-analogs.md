...
Esta página es para usuarios familiarizados con la sintaxis HTML y CSS para la organización de componentes de UI de una aplicación. Al mapear fragmentos de código HTML/CSS a sus equivalentes de código Flutter/Dart.

Este ejemplo asume:


* El documento HTML inicia con `<!DOCTYPE html>`, y el modelo de cuadros CSS  se establece para todos los elementos HTML en [`border-box`](https://css-tricks.com/box-sizing/), para obtener consistencia con el modelo de Flutter.
...
Para especificar el ancho de un widget [Container](https://docs.flutter.io/flutter/widgets/Container-class.html), utilice su propiedad `width`. Este es un ancho fijo, a diferencia de la propiedad CSS Max-width que ajusta el ancho del contenedor hasta un valor máximo.
...
En el caso de los contenedores anidados, si el ancho de los padres es menor que el ancho del niño, el Contenedor hijo se dimensiona a sí mismo para que coincida con el padre.
...
De forma predeterminada, los widgets se colocan en relación con su padre.
...
Para una operacion de escalamiento simple a lo largo del x-axis cree un nuevo objeto de identidad [Matrix4](https://docs.flutter.io/flutter/vector_math_64/Matrix4-class.html) y utilice su método scale() para especificar el factor de escala.
