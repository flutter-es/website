---
layout: page
title: "AppBar con un widget bottom personalizado."
...
Prueba esta aplicación creando un nuevo proyecto con `flutter create` y reemplazando los contenidos de `lib/main.dart` con el siguiente código.
...
- El código fuente en [examples/catalog/lib/app_bar_bottom.dart](https://github.com/flutter/flutter/blob/master/examples/catalog/lib/app_bar_bottom.dart).
